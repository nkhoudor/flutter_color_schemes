...
enum PredefinedTheme {
  ...
  const PredefinedTheme({required this.light, required this.dark, required this.textTheme});

  final PredefinedColorScheme light;
  final PredefinedColorScheme dark;
  final PredefinedTextTheme textTheme;

  ThemeData get lightTheme => _theme(light.colorScheme);
  ThemeData get darkTheme => _theme(dark.colorScheme);

  ThemeData _theme(ColorScheme colorScheme) => ThemeData(
    useMaterial3: true,
    brightness: colorScheme.brightness,
    colorScheme: colorScheme,
    textTheme: textTheme.textTheme.apply(bodyColor: colorScheme.onSurface, displayColor: colorScheme.onSurface),
...
enum PredefinedColorScheme {
  ...
  const PredefinedColorScheme({required this.colorScheme});
